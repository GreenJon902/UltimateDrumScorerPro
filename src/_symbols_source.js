export const SYMBOLS_SOURCE = "new,part,ks-base,1,path,M0 0 l-3.5 3.5," + 
                              ...
                              "new,part,right-ghost,3,push-transform,scale(-1 1),use,left-ghost,pop-transform," + 
                              ...
                              "modifier,drum,auto,ghost,2,+*drums,-kick,+1,0,+1,0,0,4,6,push-transform,translate(${0 - parent_size_left - 2} 0),use,left-ghost,pop-transform,push-transform,translate(${parent_size_right + 2} 0),use,right-ghost,pop-transform,0," + 
                              ...
                              "new,decoration,repeat-end,5,10,,,,right,0," + 
                              "new,decoration,option-end,5,10,,,,right,0," + 
                              "new,decoration,bar-end,5,10,,,,right,0";
