...
half_bar_length = global_idmap["flag_length"]
...
top_dot_stem_distance = global_idmap["top_dot_stem_distance"]
dot_head_spacing = global_idmap["dot_head_spacing"]
bar_dot_spacing = global_idmap["bar_dot_spacing"]